        ...
        return (
          <nav className="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div className="container-fluid d-flex flex-column p-0">
              <a className="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" style={{paddingRight: '64px', paddingLeft: '10px', width: '222px'}}>
              ...
              <div>
                ...
                <p className="text-left" style={{color: 'rgb(255,255,255)', paddingTop: '5px', paddingRight: '0px', paddingLeft: '30px', marginRight: '30px', marginLeft: '0px'}}>2. Chọn các cột cần ẩn danh (QI)&nbsp;</p>
                <p className="text-left" style={{color: 'rgb(255,255,255)', paddingTop: '5px', paddingLeft: '30px', marginRight: '34px'}}>3. Chọn số k</p>
                <p className="text-left" style={{color: 'rgb(255,255,255)', paddingTop: '5px', paddingLeft: '30px', marginRight: '34px'}}>4. Ấn nút 'Tạo bảng ẩn danh'</p>
              </div>
